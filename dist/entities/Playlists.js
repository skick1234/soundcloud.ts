...
var Playlists = /** @class */ (function () {
    function Playlists(api) {
        ...
        this.secretToken = function (playlistResolvable) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        playlistID = _a.sent();
                        return [4 /*yield*/, this.api.get("/playlists/".concat(playlistID, "/secret-token"))
        ...
        this.searchAlt = function (query) { return __awaiter(_this, void 0, void 0, function () {
            var html, urls, scrape, i, songHTML, json, playlist;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, undici_1.request)("https://soundcloud.com/search/sets?q=".concat(query), { headers: this.api.headers }).then(function (r) { return r.body.text(); })];
                    case 1:
                        html = _b.sent();
