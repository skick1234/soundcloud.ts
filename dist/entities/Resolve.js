...
var Resolve = /** @class */ (function () {
    function Resolve(api) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        id = resolvable;
                        if (!String(resolvable).includes("soundcloud")) return [3 /*break*/, 2];
                        return [4 /*yield*/, (0, undici_1.request)(String(resolvable), { headers: API_1.default.headers }).then(function (r) { return r.body.text(); })];
                    case 1:
                        html = _e.sent();
         ...
         */
        this.getV2 = function (resolvable, full) { return __awaiter(_this, void 0, void 0, function () {
            var id, resolved;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
